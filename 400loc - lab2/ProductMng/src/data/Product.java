...
public class Product implements Comparable<Product> {
    ...
    public void print() {
        System.out.printf("%-6s|%-28s|%-7s|%-6s|%3s \n", productID, name, price, quantity, status);
    }

    @Override
    public int compareTo(Product product) {
        return this.getProductID().compareToIgnoreCase(product.getProductID());
//        if (this.getName().compareToIgnoreCase(product.getName())) {
...
//                return 1;
//            }
//        } else if (this.getName() > product.getName()) {
//            return -1;
//        } else {
//            return 1;
//        }
